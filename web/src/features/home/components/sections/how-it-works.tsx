          ...
          {steps.map((step, i) => (
            ...
            >
              <div className='relative mb-6'>
                <div className='text-muted-foreground border-border bg-card flex size-16 items-center justify-center rounded-lg border transition-colors group-hover:text-primary'>
                  {step.icon}
                </div>
